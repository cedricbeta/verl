...
MODEL_PATH=/home/chendong/video-rl/Temporal-R1/checkpoints/easy_r1/qwen2_5_vl_7b_vqa_hf_0610
...
CUDA_VISIBLE_DEVICES=${VISIBLE_DEVICES} python3 -m verl.trainer.main_vqa \
    ...
    trainer.experiment_name=qwen2_5_vl_7b_vqa_reward_451_0611_rpp_cat \
    trainer.nnodes=1 \
    trainer.n_gpus_per_node=4 \
    +trainer.grounding_weight=0.5 \
