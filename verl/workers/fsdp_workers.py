...
class ActorRolloutRefWorker(Worker):
    ...
    def update_actor_dpo(self, data: DataProto):
        ...
        This method follows a similar structure as update_actor but calls
        the actor's update_policy_dpo function which implements the DPO loss update.
        ...
        with self.ulysses_sharding_manager:
            ...
            # Call the DPO update function on the actor
